...
export const Layout = ({buildingMarkers,items}) => {
  console.log("Props",buildingMarkers);
  ...
  const imageMapping = {
    building:
      "https://www.pnw.edu/wp-content/uploads/2023/09/PNW-Bell-Tower-077_576x384.jpg",
    parking:
      "https://www.pnw.edu/wp-content/uploads/2023/01/PNW-Signage-and-Art-033-1-scaled.jpg",
    emergency:
      "https://www.pnw.edu/public-safety/wp-content/uploads/sites/84/2020/01/hammond-campus-police_900_feature-900x600.jpg",
    dining:
      "https://bloximages.chicago2.vip.townnews.com/nwitimes.com/content/tncms/assets/v3/editorial/5/2d/52d22b54-96d6-514a-98eb-c47340a7e60f/63ed822fb2d9f.image.jpg?resize=1200%2C800",
    Entry:
      "https://www.pnw.edu/wp-content/uploads/2020/02/WhyPNW_Housing_800x533.jpg",
    services:
      "https://media.licdn.com/dms/image/D5622AQGzSxTMAUw5og/feedshare-shrink_800/0/1670782442632?e=2147483647&v=beta&t=-wlGCteOZSrUb8Ao6IkuNOGbmZ0Ue35oqhSpUVR5EAE",
  };
  useEffect(() => {
    ...
    <div className="page">
      <div className="header">
        <div className="header-content">
          ...
          <div className="logo">
            <img
              src="https://leapassets.s3.ap-south-1.amazonaws.com/PNW_a5ddbab748.PNG"
              alt="Logo"
            />
          </div>
        </div>
      ...
      <div className="split-container">
        <div className="left-panel">
          <div className="top-image">
            <img
              src={
                imageMapping[selectedOption] ||
                "https://images.adsttc.com/media/images/605b/8922/f91c/8171/5b00/00f7/large_jpg/005433_00_N158_letter.jpg?1616611604"
              }
              alt="Top Image"
            />
          </div>
