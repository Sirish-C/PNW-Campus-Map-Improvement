...
const Lawshe = () => (
  <div>
    ...
    <p>Lawshe Hall (LAWS) is located in the southwest area of the Hammond campus,
       east of Woodmar Ave., north and west of North 173rd Street Parking, southwest of the Student Union 
       & Library Building,and north of 173rd Street. LAWS is located at the southern end of the Peregrine Path.</p>
...
<li>Finance & Administration - room 336</li>
  ...
  <li><h4>Interior Floor Plan</h4>
  <a href="https://www.pnw.edu/getting-to-pnw/wp-content/uploads/sites/7/2020/01/lawshe-hall-third-floor.pdf" target="_blank">Second Floor</a>
</li>
