...
const Powers  = () => (
  <div style={{ padding: '20px', backgroundColor: '#e6f7ff', minHeight: '100vh' }}>
    ...
    <p>Powers Computer Education Building (PWRS) is located in the northwest corner of the Hammond campus, 
      east of Woodmar Ave. and west of 169th Street Parking, south of the Classroom Office Building,
        just north of the Gyte Annex Building and just west of the Potter Building. </p>
